...
export default function AddPaintScreen() {
  ...
  const validateFormData = () => {
    if (
      ...
      setIsLoading(true);
      if (formData.url) {
        uploadPaintFile(formData.url, (response: number, filePath: string) => {
          response === 200
  ...
  const uploadPaintFile = async (
    ...
    const filePath =
      "../Ordering_system/stock_icon/paint" +
